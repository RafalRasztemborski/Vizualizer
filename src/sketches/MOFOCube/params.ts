...
export const MOFO_CUBE_PARAMS: SketchParamDefinition[] = [
    ...
    {
      key: 'mirrorFrontWall',
      label: 'Front wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'frontWallLayout',
      label: 'Front wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
    ...
    {
      key: 'mirrorBackWall',
      label: 'Back wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'backWallLayout',
      label: 'Back wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
    ...
    {
      key: 'mirrorLeftWall',
      label: 'Left wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'leftWallLayout',
      label: 'Left wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
    ...
    {
      key: 'mirrorRightWall',
      label: 'Right wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'rightWallLayout',
      label: 'Right wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
    ...
    {
      key: 'mirrorTopWall',
      label: 'Top wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'topWallLayout',
      label: 'Top wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
    ...
    {
      key: 'mirrorBottomWall',
      label: 'Bottom wall mirror',
      type: 'boolean',
      defaultValue: false,
    },
    {
      key: 'bottomWallLayout',
      label: 'Bottom wall layout',
      type: 'select',
      options: [
        'normal',
        'flipPrimary',
